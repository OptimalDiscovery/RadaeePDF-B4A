...
@ShortName("PDFViewDual")
public class RSPDFViewDual extends AbsObjectWrapper<PDFViewDual> {
	...
	public void Initialize(final BA ba, String EventName) {
		...
		setObject(new PDFViewDual(BA.applicationContext));
	}
	...
	/**
	 * verts - applied duals flag for vertical screen horzs - applied duals flag
	...
	public void vSetLayoutPara(boolean[] verts, boolean[] horzs, boolean rtol) {
		getObject().vSetLayoutPara(verts, horzs, rtol);
	}
