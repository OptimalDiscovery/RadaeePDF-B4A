...
@ShortName("PDFViewThumb")
public class RSPDFViewThumb extends AbsObjectWrapper<PDFViewThumb> {
	...
	public void Initialize(final BA ba, String EventName) {
		...
		setObject(new PDFViewThumb(BA.applicationContext));
	}
	...
	public int getOrientation() {
		return getObject().vGetOrientation();
	}

	public void setOrientation(int dir) {
		getObject().vSetOrientation(dir);
	}

	/**
	 * Raises _PageClicked (pageNo as int)
	 */
	public void setThumbListener() {
		getObject().vSetThumbListener(pdfThumbListener);
	}

	PDFThumbListener pdfThumbListener = new PDFThumbListener() {

		@Override
		public void OnPageClicked(int pageNo) {
			if (ba.subExists(eventName + "_pageclicked") == true) {
				ba.raiseEvent(this, eventName + "_pageclicked", new Object[] { pageNo });
			}
