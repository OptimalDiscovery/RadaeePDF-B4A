...
@ShortName("PDFViewHorz")
public class RSPDFViewHorz extends AbsObjectWrapper<PDFViewHorz> {
	...
	public void Initialize(final BA ba, String EventName) {
		...
		setObject(new PDFViewHorz(BA.applicationContext));
	}

	// Methods

	public void setDirection(boolean rtol) {
		getObject().vSetDirection(rtol);
	}
